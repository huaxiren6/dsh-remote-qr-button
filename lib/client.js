  ...
  factory: () => {
    ...
    function apply(ctx) {
      ctx.effect(() => {
        ...
        const img = document.getElementById('dsh-remote-qr-img')
        const shortEl = document.getElementById('dsh-remote-qr-short')
        const ttlEl = document.getElementById('dsh-remote-qr-ttl')
        const missing = document.getElementById('dsh-remote-qr-missing')
        const body = document.getElementById('dsh-remote-qr-body')
        let pollTimer = null
        let countdown = null
        let left = 0
        ...
        document.getElementById('dsh-remote-qr-close').onclick = close
        function close() {
